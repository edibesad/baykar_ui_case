  ...
  return (
    <>
      <div className="mx-auto max-w-screen-xl flex flex-col mt-[89px]">
        <div className="absolute h-[950px] top-0 right-0 left-0 bg-linear-to-b from-white to-[var(--colour-1)] rounded-b-full opacity-30 -z-50" />
      ...
      <div className="flex w-full justify-center items-center md:flex-row flex-col md:h-[100px] gap-[30px] mt-[4rem]">
